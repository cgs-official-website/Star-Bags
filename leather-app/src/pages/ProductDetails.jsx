      ...
      <div className="container py-4">
        ...
        <div className="row mb-5">
          ...
          <div className="col-lg-6 mb-4 mb-lg-0">
            ...
            >
              <button className="arrow-btn d-none d-md-block" onClick={handlePrevImage}><IoIosArrowBack /></button>
              <img 
              ...
              />
              <button className="arrow-btn d-none d-md-block" onClick={handleNextImage}><IoIosArrowForward /></button>
            </div>
          ...
          <div className="col-lg-6 ps-lg-5">
            ...
            <div className="delivery-box mt-4">
              <div className="d-flex justify-content-between align-items-center mb-2">
                ...
                <h6 className="cursor-pointer" style={{color:'#8b5cf6',fontSize:'13px', fontWeight:'400'}}>Change Location <span className="bi bi-pencil-square"></span></h6>
              </div>
              <hr style={{width:'100%', borderColor: '#ddd'}} className="my-2"/>
              <div className="text-muted mt-2" style={{fontSize: '0.9rem'}}>
                <p className="mb-1">Rahul Sharma, Flat No. 302, Sai Residency</p>
        ...
        <div className="reviews-section">
          ...
          <div className="overall-rating-card shadow-sm">
            <div className="rating-score">
              <h2>4.6 <FaStar className="fs-4" /></h2>
              <p>24,000 Ratings</p>
              <p>&</p>
              <p>8,000 Reviews</p>
            </div>
            ...
            <div className="rating-bars">
              {[5, 4, 3, 2, 1].map((star) => (
                <div key={star} className="rating-bar-row">
                  <span>{star} <FaStar className="text-warning" /></span>
                  <div className="progress-custom">
                    <div 
                      className="progress-bar-fill" 
                      style={{ 
                        width: star === 5 ? '80%' : star === 4 ? '50%' : star === 3 ? '20%' : star === 2 ? '5%' : '10%',
                        backgroundColor: star >= 3 ? '#22c55e' : star === 2 ? '#fbbf24' : '#ef4444'
                      }}
                    ></div>
                  </div>
                  <span className="text-muted" style={{width: '40px', textAlign: 'right'}}>
                    {star === 5 ? '12k' : star === 4 ? '5k' : star === 3 ? '2k' : star === 2 ? '100' : '50'}
                  </span>
                </div>
              ))}
            </div>
                ...
                <div className="review-card">
                  <div className="review-header">
                    <div className="reviewer-info">
                      <img src="https://i.pravatar.cc/150?img=33" alt="Reviewer" className="reviewer-avatar" />
                  ...
                  <p className="review-text">
                    The Product was quite good my relative was using this product i will give 5 star for this product more over i am satisfied.
                  </p>
                  <div className="review-actions">
                   <div className="d-flex align-items-center gap-1">
                    <p style={{fontSize:'14px', fontWeight:'500', marginBottom:'0'}}>Was this helpful?</p>
                    ...
                    <div className="helpful-btns">
                      ...
                      >
                        {feedbackState[item] === 'like' ? <BiSolidLike /> : <BiLike />}
                      </button>
                      <button 
                        style={{color:'#f25858', fontSize:'18px'}}
                        onClick={() => handleFeedback(item, 'dislike')}
                      >
                        {feedbackState[item] === 'dislike' ? <BiSolidDislike /> : <BiDislike />}
                      </button>
                    </div>
                   </div>
                  </div>
        ...
        <div className="related-products-section">
          ...
          <p>Premium Leather Furniture Crafted For Comfort, Durability, And Timeless Style Designed To Elevate Every Space.</p>
