        ...
        <div className="to-main-grid">
          <div className="to-left">
            ...
            <div className="to-card to-product-card border rounded-3 p-4 bg-white shadow-sm">
              <div className="to-product-info" style={{ display: "flex", alignItems: "flex-start", gap: "0.9rem" }}>
                <img
                  src={order.image || "../src/assets/images/leather1.png"}
                  alt={order.product}
                  className="to-product-img rounded"
                  style={{ width: "90px", height: "90px", objectFit: "cover", border: "1px solid #f1f5f9", flexShrink: 0 }}
                />
                {/* Details wrapper is position:relative so badge is absolute inside it — name gets full width */}
                <div className="to-product-details" style={{ flex: 1, minWidth: 0, position: "relative", paddingRight: matchedProduct ? "70px" : "0" }}>
                  {/* Badge sits top-right inside the details block, no wrapping effect on name */}
                  {matchedProduct && (
                    <div
                      className="to-product-rating-badge"
                      style={{ position: "absolute", top: 0, right: 0 }}
                    >
                      <FaStar style={{ color: "#f59e0b" }} />
                      <span style={{ fontWeight: 700 }}>{Number(matchedProduct.rating || 0).toFixed(1)}</span>
                    </div>
                  )}
