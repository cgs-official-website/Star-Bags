...
const SearchModal = ({
  ...
  return (
    <div className="sm-wrapper" ref={wrapperRef}>

      {/* ── Search bar ── */}
      <form className="sm-bar" onSubmit={handleSubmit}>
        <input
          ref={inputRef}
          type="text"
      ...
      {isOpen && (
        <div className="sm-dropdown">
          ...
          {/* State 1 — empty query: recent + thumbnails */}
          {isEmptyQuery && (
            <>
              {/* Recent searches */}
              {recent.length > 0 && (
...
//           {/* State 1 — empty query: thumbnails */}
//           {isEmptyQuery && (
//             <ul className="sm-list">
//               {list.slice(0, 6).map((product, i) => (
//                 <li
